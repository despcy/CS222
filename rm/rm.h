...
public:
    ...
    RC getNextTuple(RID &rid, void *data) {return iterator.getNextRecord(rid,data);};
...
private:
    ...
    void typeVarchar2data(void* data, unsigned length,std::string s);
    void typeInt2data(void* data, unsigned value);
    void typeReal2data(void* data, float value);
    int assignTableID();

    int getTableID(std::string tablename);
